...
public class PdfUtil {
    ...
    public static ByteArrayInputStream CartEntries(List<CartEntry> cartEntries) {
        ...
        try {
            ...
            for (CartEntry cartEntry : cartEntries) {
                ...
                cell = new PdfPCell(new Phrase(cartEntry.getId().toString()));
                ...
                cell = new PdfPCell(new Phrase(String.valueOf(cartEntry.getQuantity())));
                cell.setVerticalAlignment(Element.ALIGN_MIDDLE);
